...
const Contribute: NextPage = () => {
	...
	return (
		<div className="grid justify-stretch md:justify-center px-4 md:px-0 py-10">
			<h1 className="font-comic-cat text-primary text-center mb-10">SUBMIT A SURVEY</h1>
			<div className="mb-10">
				<Steps steps={SURVEY_STEPS} />
			</div>
			<div className="bg-primary md:w-[700px] w-full md:px-12 p-8 rounded-lg">
