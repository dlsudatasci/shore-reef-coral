...
export default function GetInvolvedButton({ icon, text, href }: GetInvolvedButtonProps) {
	return (
		<Link className="grid max-w-[150px] hover:scale-105 hover:bg-secondary transition-all
		fill-secondary hover:fill-primary text-secondary hover:text-primary group" href={href}>
